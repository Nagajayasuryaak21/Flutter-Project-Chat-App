...
class LoveFilter {
  ...
  ///[badWordsList].
  LoveFilter.filterOnly(List<String> badWordsList) {
  ...
  LoveFilter.ignore(List<String> ignoreList) {
  ...
  LoveFilter.filterAdditionally(List<String> badWordsList) {
  ...
  bool hasLove(String inputString) {
